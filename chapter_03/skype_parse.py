...
def printProfile(skypeDB):
    ...
    c = conn.cursor()
    c.execute("SELECT fullname, skypename, city, coutnry, datetime(profile_timestamp,'unixepoch') FROM Accounts;")
...
def printCallLog(skypeDB):
    ...
    c.execute("SELECT datetime(begin_timestamp, 'unixepoch'), identity FROM calls, converstaion WHERE call.conv_dbid = conversations.id;")
